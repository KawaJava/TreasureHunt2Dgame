            ...
            if (target[i] != null) {
                ...
                if (entity.solidArea.intersects(target[i].solidArea)) {
                    if (target[i] != entity) {
                        ...
                        entity.collisionOn = true;
                        index = i;
                        if(entity.frozen == true && target[i].frozen == false && target[i].type == target[i].type_monster
                                && entity.falling == true){
                            target[i].alive = false;
                            gp.player.totalDamage += target[i].life;
                            gp.ui.addMessage(target[i].life + " damage - frozen monster");
                        }
